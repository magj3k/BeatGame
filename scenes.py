...
scene_3_water_map_2[70:93] = [-1+scene_elevation_offset]*23
...
scene_4_water_map_1 = [0]*155
scene_4_water_map_2 = [0]*155
scene_4_ground_map = [0+scene_elevation_offset]*155
scene_4_ground_map[0:22] = [4+scene_elevation_offset]*22
scene_4_ground_map[32:34] = [1+scene_elevation_offset]*2
scene_4_ground_map[34:36] = [2+scene_elevation_offset]*2
scene_4_ground_map[54:56] = [2+scene_elevation_offset]*2
scene_4_ground_map[56:58] = [1+scene_elevation_offset]*2
scene_4_ground_map[36:54] = [-5+scene_elevation_offset]*19
scene_4_water_map_1[36:54] = [-1+scene_elevation_offset]*19
scene_4_ground_map[42:49] = [2+scene_elevation_offset]*7
scene_4_ground_map[123:155] = [4+scene_elevation_offset]*32
scene_4_ground_map[72:82] = [1+scene_elevation_offset]*10
scene_4_ground_map[73:81] = [2+scene_elevation_offset]*8
scene_4_ground_map[74:80] = [12+scene_elevation_offset]*6
scene_4_ground_map[92:116] = [1+scene_elevation_offset]*24
scene_4_ground_map[94:114] = [2+scene_elevation_offset]*20
scene_4_ground_map[96:112] = [-5+scene_elevation_offset]*16
...
scene_4_game_elements = [   scene_4_door,
                                                    TexturedElement(pos = (615, 213),
                                                        z = 101,
                                                        size = (500*0.13, 500*0.13),
                                                        texture_path = "graphics/door_closed.png"),
                                                    TexturedElement(pos = (2350+scene_4_door_offset, 280),
                                                        z = 99,
                                                        size = (458*0.17, 490*0.17),
                                                        texture_path = "graphics/not_enough_keys.png",
                                                        tag = "door_warning"),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (0, -300),
                                                        ...
                                                        color = Color(0.2, 0.4, 0.15)),
                                                        parallax_z = 60),
                                                    Backdrop(element = TexturedElement(pos = (-220, -10),
                                                        z = 5,
                                                        size = (532*0.7, 266*0.7),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.35, 0.35, 0.35)),
                                                        parallax_z = 200),
                                                    Backdrop(element = TexturedElement(pos = (-60, -10),
                                                        z = 5,
                                                        size = (532*1.25, 266*1.25),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.35, 0.35, 0.35)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (-145, -40),
                                                        ...
                                                        color = Color(0.375, 0.375, 0.375)),
                                                        parallax_z = 50),
                                                    Backdrop(element = TexturedElement(pos = (-20, -40),
                                                        z = 13,
                                                        size = (532*1.1, 266*1.1),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.4, 0.4, 0.4)),
                                                        parallax_z = 25),
                                                    Backdrop(element = TexturedElement(pos = (240, -80),
                                                        z = 13,
                                                        size = (532*1.2, 266*1.2),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.4, 0.4, 0.4)),
                                                        parallax_z = 25),
                                                    Backdrop(element = TexturedElement(pos = (380, -80),
                                                        z = 13,
                                                        size = (532*1.1, 266*1.1),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.4, 0.4, 0.4)),
                                                        parallax_z = 25),
                                                    Backdrop(element = TexturedElement(pos = (-130, -90),
                                                        z = 14,
                                                        size = (532*1.15, 266*1.15),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.425, 0.425, 0.425)),
                                                        parallax_z = 15),
                                                    Backdrop(element = TexturedElement(pos = (660, -100),
                                                        z = 15,
                                                        size = (532*1.2, 266*1.2),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.43, 0.43, 0.43)),
                                                        parallax_z = 12),
                                                    Backdrop(element = TexturedElement(pos = (1400, -90),
                                                        z = 38,
                                                        size = (1450*0.5, 886*0.5),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.2, 0.2, 0.2)),
                                                        parallax_z = 2.5),
                                                    Backdrop(element = TexturedElement(pos = (1400, -90),
                                                        z = 38,
                                                        size = (1450*0.5, 886*0.5),
                                                        texture_path = "graphics/hill_3_lava.png",
                                                        color = Color(0.8, 0.1, 0.1)),
                                                        parallax_z = 2.5),
                                                    Backdrop(element = TexturedElement(pos = (800, 20),
                                                        z = 37,
                                                        size = (1466*0.5, 519*0.5),
                                                        texture_path = "graphics/hill_1.png",
                                                        color = Color(0.3, 0.5, 0.25)),
                                                        parallax_z = 3.0),
                                                    Backdrop(element = TexturedElement(pos = (320, 10),
                                                        z = 37,
                                                        size = (-1466*0.5, 519*0.5),
                                                        texture_path = "graphics/hill_1.png",
                                                        color = Color(0.3, 0.5, 0.25)),
                                                        parallax_z = 3.0),
                                                    Backdrop(element = TexturedElement(pos = (100, 40),
                                                        z = 39,
                                                        size = (1466*0.6, 519*0.6),
                                                        texture_path = "graphics/hill_1.png",
                                                        color = Color(0.325, 0.525, 0.275)),
                                                        parallax_z = 1.5),
                                                    Backdrop(element = TexturedElement(pos = (800, 10),
                                                        z = 39,
                                                        size = (-1466*0.6, 519*0.6),
                                                        texture_path = "graphics/hill_1.png",
                                                        color = Color(0.325, 0.525, 0.275)),
                                                        parallax_z = 1.5),
                                                    Backdrop(element = TexturedElement(pos = (1550, -120),
                                                        z = 39,
                                                        size = (-1450*0.6, 886*0.6),
                                                        texture_path = "graphics/hill_3.png",
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (1550, -120),
                                                        ...
                                                        parallax_z = 1.5),
                                                    Backdrop(element = TexturedElement(pos = (1030, 30),
                                                        z = 40,
                                                        size = (1414*1.05, 370*1.05),
                                                        texture_path = "graphics/hill_2.png",
                                                        color = Color(0.35, 0.55, 0.3)),
                                                        parallax_z = 0.5),
                                                    Backdrop(element = TexturedElement(pos = (1030, 30),
                                                        ...
                                                        color = Color(0.3, 0.3, 0.9)),
                                                        parallax_z = 0.5),
                                                    Terrain(scene_4_ground_map,
                                                        z = 100,
                                                        color = Color(0, 0, 0),
                                                        res = scene_resolution),
                                                    Terrain(scene_4_water_map_1,
                                                        z = 111,
                                                        color = Color(0.35, 0.35, 0.95),
                                                        res = scene_resolution,
                                                        type = "water"),
                                                    Terrain(scene_4_water_map_2,
                                                        z = 111,
                                                        color = Color(1.0, 0.2, 0.2),
                                                        res = scene_resolution,
                                                        type = "water"),
                                                    Pickup(TexturedElement(pos = (77*scene_resolution, 24.25*scene_resolution),
                                                        size = (166*0.091, 400*0.091),
                                                        texture_path = "graphics/key.png"), z = 110, radius = 20),
                                                    Platform(((38, 7), (39, 7)),
                                                        type = "dirt",
                                                    ...
                                                    Platform(((51, 7), (52, 7)),
                                                        ...
                                                        active = False,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    Spikes(world_pos = (44, 9),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [1, 5],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Spikes(world_pos = (45.5, 9),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 6],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Spikes(world_pos = (47, 9),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [3, 7],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Platform(((72, 15), (81, 15)),
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = False,
                                                        beats = [],
                                                    ...
                                                    Platform(((80, 20.35), (81, 20.35)),
                                                        ...
                                                        active = True,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    TexturedElement(pos = (77*scene_resolution, 18*scene_resolution),
                                                        z = 100,
                                                        size = (10.0*scene_resolution, 5.0*scene_resolution),
                                                        texture_path = "graphics/bg_2.png",
                                                        color = Color(0, 0, 0)),
                                                    JumpPad(world_pos = (69, 7),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 4],
                                                        res = scene_resolution,
                                                        sound_path = "audio/jumppad.wav"),
                                                    JumpPad(world_pos = (85, 7),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 4],
                                                        res = scene_resolution,
                                                        sound_path = "audio/jumppad.wav"),
                                                    Platform(((68, 14), (69, 14)),
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = True,
                                                        beats = [2, 4],
                                                    ...
                                                    Platform(((84, 18), (85, 18)),
                                                        ...
                                                        active = True,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    Spikes(world_pos = (95, 9),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [1, 3, 5, 7],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Spikes(world_pos = (113, 9),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [1, 3, 5, 7],
                                                        res = scene_resolution,
...
scene_4_enemies = [
    Enemy(res = scene_resolution, initial_world_pos = (62, 7), radius = 40, z = 110, moves_per_beat = ["stop", "right", "stop", "left", "stop", "right", "stop", "right", "stop", "left", "stop", "left"], has_key = True),
    Enemy(res = scene_resolution, initial_world_pos = (102.25, 8), radius = 40, z = 110, moves_per_beat = ["stop", "right", "stop", "left"], has_key = True)
]
scene_4_game_elements.extend(scene_4_enemies)
scene_4_UI_elements = []
...
scene_5_water_map_1 = [0]*200
scene_5_water_map_2 = [0]*200
scene_5_water_map_3 = [0]*200
scene_5_ground_map = [0+scene_elevation_offset]*200
scene_5_ground_map[0:22] = [4+scene_elevation_offset]*22
scene_5_ground_map[27:35] = [-1+scene_elevation_offset]*8
scene_5_ground_map[40:50] = [1+scene_elevation_offset]*10 # TOWER
scene_5_ground_map[41:49] = [2+scene_elevation_offset]*8 # TOWER
scene_5_ground_map[42:48] = [12+scene_elevation_offset]*6 # TOWER
scene_5_ground_map[51] = -1+scene_elevation_offset
scene_5_ground_map[52:67] = [-5+scene_elevation_offset]*15
scene_5_water_map_1[52:67] = [-2+scene_elevation_offset]*15
scene_5_ground_map[67] = -1+scene_elevation_offset
scene_5_ground_map[69:79] = [1+scene_elevation_offset]*10 # TOWER
scene_5_ground_map[70:78] = [2+scene_elevation_offset]*8 # TOWER
scene_5_ground_map[71:77] = [12+scene_elevation_offset]*6 # TOWER
scene_5_ground_map[89:91] = [1+scene_elevation_offset]*2
scene_5_ground_map[91:118] = [-5+scene_elevation_offset]*27
scene_5_water_map_2[91:118] = [-1+scene_elevation_offset]*27
scene_5_ground_map[118:120] = [1+scene_elevation_offset]*2
scene_5_ground_map[99:110] = [1+scene_elevation_offset]*11
scene_5_ground_map[128:130] = [1+scene_elevation_offset]*2
scene_5_ground_map[130:157] = [-5+scene_elevation_offset]*27
scene_5_water_map_3[130:157] = [-1+scene_elevation_offset]*27
scene_5_ground_map[157:159] = [1+scene_elevation_offset]*2
scene_5_ground_map[132:134] = [9+scene_elevation_offset]*2
scene_5_ground_map[136:138] = [7+scene_elevation_offset]*2
scene_5_ground_map[153:155] = [9+scene_elevation_offset]*2
scene_5_ground_map[149:151] = [7+scene_elevation_offset]*2
scene_5_ground_map[168:199] = [28+scene_elevation_offset]*31
scene_5_player = Player(res = scene_resolution, initial_world_pos = (25, 7.5), z = 110)
# scene_5_player.flight_enabled = True
scene_5_door_offset = scene_resolution*88
scene_5_door = TexturedElement(pos = (2445 + scene_5_door_offset, 213),
                                z = 101,
                                size = (500*0.13, 500*0.13),
                                texture_path = "graphics/door_closed.png",
                                tag = "door")

scene_5_game_elements = [   scene_5_door,
                                                    TexturedElement(pos = (615, 213),
                                                        z = 101,
                                                        size = (500*0.13, 500*0.13),
                                                        texture_path = "graphics/door_closed.png"),
                                                    TexturedElement(pos = (2350+scene_5_door_offset, 280),
                                                        z = 99,
                                                        size = (458*0.17, 490*0.17),
                                                        texture_path = "graphics/not_enough_keys.png",
                                                        tag = "door_warning"),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (0, -300),
                                                        ...
                                                        color = Color(0.2, 0.4, 0.15)),
                                                        parallax_z = 60),
                                                    Backdrop(element = TexturedElement(pos = (-620, -10),
                                                        z = 5,
                                                        size = (532*0.7, 266*0.7),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.35, 0.35, 0.35)),
                                                        parallax_z = 200),
                                                    Backdrop(element = TexturedElement(pos = (-460, -10),
                                                        z = 5,
                                                        size = (532*1.25, 266*1.25),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.35, 0.35, 0.35)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (-460, -10),
                                                        ...
                                                        color = Color(1, 1, 1)),
                                                        parallax_z = 200),
                                                    Backdrop(element = TexturedElement(pos = (-270, -10),
                                                        z = 5,
                                                        size = (532*0.9, 266*0.9),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.35, 0.35, 0.35)),
                                                        parallax_z = 200),
                                                    Backdrop(element = TexturedElement(pos = (-160, -10),
                                                        z = 5,
                                                        size = (532*0.5, 266*0.5),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.35, 0.35, 0.35)),
                                                        parallax_z = 200),
                                                    Backdrop(element = TexturedElement(pos = (-365, -80),
                                                        z = 12,
                                                        size = (532*1.5, 266*1.5),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.375, 0.375, 0.375)),
                                                        parallax_z = 50),
                                                    Backdrop(element = TexturedElement(pos = (120, -105),
                                                        z = 12,
                                                        size = (532*1.5, 266*1.5),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.375, 0.375, 0.375)),
                                                        parallax_z = 50),
                                                    Backdrop(element = TexturedElement(pos = (380, -75),
                                                        z = 12,
                                                        size = (532*1.5, 266*1.5),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.375, 0.375, 0.375)),
                                                        parallax_z = 50),
                                                    Backdrop(element = TexturedElement(pos = (-70, -120),
                                                        z = 13,
                                                        size = (532*1.5, 266*1.5),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.4, 0.4, 0.4)),
                                                        parallax_z = 20),
                                                    Backdrop(element = TexturedElement(pos = (-450, -120),
                                                        z = 13,
                                                        size = (532*1.5, 266*1.5),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.4, 0.4, 0.4)),
                                                        parallax_z = 20),
                                                    Backdrop(element = TexturedElement(pos = (680, -120),
                                                        z = 13,
                                                        size = (532*1.5, 266*1.5),
                                                        texture_path = "graphics/mountain.png",
                                                        color = Color(0.4, 0.4, 0.4)),
                                                        parallax_z = 20),
                                                    Backdrop(element = TexturedElement(pos = (900, -70),
                                                        z = 30,
                                                        size = (-1450*0.65, 886*0.65),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.25, 0.25, 0.25)),
                                                        parallax_z = 0.7),
                                                    Backdrop(element = TexturedElement(pos = (900, -70),
                                                        ...
                                                        parallax_z = 0.7),
                                                    Backdrop(element = TexturedElement(pos = (1800, -60),
                                                        z = 30,
                                                        size = (1450*0.65, 886*0.65),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.25, 0.25, 0.25)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (1800, -60),
                                                        ...
                                                        color = Color(1, 0.25, 0.25)),
                                                        parallax_z = 0.7),
                                                    Backdrop(element = TexturedElement(pos = (2600, -70),
                                                        z = 30,
                                                        size = (-1450*0.65, 886*0.65),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.25, 0.25, 0.25)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (2600, -70),
                                                        ...
                                                        color = Color(1, 0.25, 0.25)),
                                                        parallax_z = 0.7),
                                                    Backdrop(element = TexturedElement(pos = (100, -60),
                                                        z = 29,
                                                        size = (1450*0.55, 886*0.55),
                                                        texture_path = "graphics/hill_3.png",
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (100, -60),
                                                        ...
                                                        parallax_z = 1.65),
                                                    Backdrop(element = TexturedElement(pos = (900, -60),
                                                        z = 29,
                                                        size = (1450*0.55, 886*0.55),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.275, 0.275, 0.275)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (900, -60),
                                                        ...
                                                        color = Color(1, 0.3, 0.3)),
                                                        parallax_z = 1.65),
                                                    Backdrop(element = TexturedElement(pos = (2000, -60),
                                                        z = 29,
                                                        size = (1450*0.55, 886*0.55),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.275, 0.275, 0.275)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (2000, -60),
                                                        ...
                                                        color = Color(1, 0.3, 0.3)),
                                                        parallax_z = 1.65),
                                                    Backdrop(element = TexturedElement(pos = (300, -30),
                                                        z = 28,
                                                        size = (-1450*0.47, 886*0.47),
                                                        texture_path = "graphics/hill_3.png",
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (300, -30),
                                                        ...
                                                        parallax_z = 4.0),
                                                    Backdrop(element = TexturedElement(pos = (800, -40),
                                                        z = 28,
                                                        size = (-1450*0.47, 886*0.47),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.3, 0.3, 0.3)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (800, -40),
                                                        ...
                                                        color = Color(1, 0.35, 0.35)),
                                                        parallax_z = 4.0),
                                                    Backdrop(element = TexturedElement(pos = (1300, -50),
                                                        z = 28,
                                                        size = (-1450*0.47, 886*0.47),
                                                        texture_path = "graphics/hill_3.png",
                                                        color = Color(0.3, 0.3, 0.3)),
                                                    ...
                                                    Backdrop(element = TexturedElement(pos = (1300, -50),
                                                        ...
                                                        color = Color(1, 0.35, 0.35)),
                                                        parallax_z = 4.0),
                                                    Backdrop(element = TexturedElement(pos = (400, 30),
                                                        z = 27,
                                                        size = (452*0.3, 1226*0.3),
                                                        texture_path = "graphics/tower_1.png",
                                                        color = Color(0.18, 0.18, 0.18)),
                                                        parallax_z = 10.0),
                                                    Terrain(scene_5_ground_map,
                                                        z = 100,
                                                        color = Color(0, 0, 0),
                                                        res = scene_resolution),
                                                    Terrain(scene_5_water_map_1,
                                                        z = 111,
                                                        color = Color(1.0, 0.2, 0.2),
                                                        res = scene_resolution,
                                                        type = "water"),
                                                    Terrain(scene_5_water_map_2,
                                                        z = 111,
                                                        color = Color(1.0, 0.2, 0.2),
                                                        res = scene_resolution,
                                                        type = "water"),
                                                    Terrain(scene_5_water_map_3,
                                                        z = 111,
                                                        color = Color(1.0, 0.2, 0.2),
                                                        res = scene_resolution,
                                                        type = "water"),
                                                    Platform(((40, 15), (49, 15)),  # START TOWER 1
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = False,
                                                        beats = [],
                                                    ...
                                                    Platform(((48, 20.35), (49, 20.35)),
                                                        ...
                                                        active = True,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    TexturedElement(pos = (45*scene_resolution, 18*scene_resolution),
                                                        z = 100,
                                                        size = (10.0*scene_resolution, 5.0*scene_resolution),
                                                        texture_path = "graphics/bg_2.png",
                                                        color = Color(0, 0, 0)),
                                                    JumpPad(world_pos = (37, 7),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 4],
                                                        res = scene_resolution,
                                                        sound_path = "audio/jumppad.wav"), # END TOWER 1
                                                    Platform(((36, 14), (37, 14)),
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = True,
                                                        beats = [2, 4],
                                                    ...
                                                    Platform(((36, 18), (37, 18)),
                                                        ...
                                                        active = True,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    Platform(((69, 15), (78, 15)),  # START TOWER 2
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = False,
                                                        beats = [],
                                                    ...
                                                    Platform(((77, 20.35), (78, 20.35)),
                                                        ...
                                                        active = True,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    TexturedElement(pos = (74*scene_resolution, 18*scene_resolution),
                                                        z = 100,
                                                        size = (10.0*scene_resolution, 5.0*scene_resolution),
                                                        texture_path = "graphics/bg_2.png",
                                                        color = Color(0, 0, 0)),
                                                    JumpPad(world_pos = (82, 7),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 4],
                                                        res = scene_resolution,
                                                        sound_path = "audio/jumppad.wav"), # END TOWER 2
                                                    Platform(((81, 14), (82, 14)),
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = True,
                                                        beats = [2, 4],
                                                    ...
                                                    Platform(((56.5, 8), (61.5, 8)),
                                                        ...
                                                        active = True,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    TexturedElement(pos = (59.5*scene_resolution, 10.5*scene_resolution),
                                                        z = 100,
                                                        size = (6.0*scene_resolution, 4.0*scene_resolution),
                                                        texture_path = "graphics/bg_2.png",
                                                        color = Color(0, 0, 0)),
                                                    JumpPad(world_pos = (59.5, 14),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 4],
                                                        res = scene_resolution,
                                                        sound_path = "audio/jumppad.wav"),
                                                    Platform(((52, 18), (53, 18)),
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = True,
                                                        beats = [2],
                                                    ...
                                                    Platform(((65, 18), (66, 18)),
                                                        ...
                                                        active = True,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    Pickup(TexturedElement(pos = (59.5*scene_resolution, 23*scene_resolution),
                                                        size = (166*0.091, 400*0.091),
                                                        texture_path = "graphics/key.png"), z = 110, radius = 20),
                                                    Platform(((94, 6), (95, 6)),
                                                        type = "dirt",
                                                    ...
                                                    Platform(((113, 6), (114, 6)),
                                                        ...
                                                        active = False,
                                                        sound_path = "audio/platform_sfx.wav"),
                                                    Spikes(world_pos = (100, 8),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [1, 3, 5, 7],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Spikes(world_pos = (109, 8),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [1, 3, 5, 7],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    JumpPad(world_pos = (129, 8),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 4],
                                                        res = scene_resolution,
                                                        sound_path = "audio/jumppad.wav"),
                                                    Spikes(world_pos = (133, 16),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Spikes(world_pos = (137, 14),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    JumpPad(world_pos = (158, 8),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2, 4],
                                                        res = scene_resolution,
                                                        sound_path = "audio/jumppad.wav"),
                                                    Spikes(world_pos = (154, 16),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Spikes(world_pos = (150, 14),
                                                        z = 99,
                                                        color = Color(0, 0, 0),
                                                        beats = [2],
                                                        res = scene_resolution,
                                                        sound_path = "audio/spike.wav"),
                                                    Platform(((139.5, 10), (146.5, 10)),
                                                        type = "dirt",
                                                        z = 100,
                                                        musical = False,
                                                        beats = [],
...
scene_5_enemies = [
    Enemy(res = scene_resolution, initial_world_pos = (103.5, 8), radius = 40, z = 110, moves_per_beat = ["stop", "right", "stop", "left"], has_key = True),
    Enemy(res = scene_resolution, initial_world_pos = (142.5, 12), radius = 40, z = 110, moves_per_beat = ["stop", "right", "stop", "left"], has_key = True),
    Enemy(res = scene_resolution, initial_world_pos = (30, 6), radius = 40, z = 110, moves_per_beat = ["stop", "right", "stop", "left"], has_key = False)
]

scene_5_game_elements.extend(scene_5_enemies)
scene_5_UI_elements = []
scene_5_UI_elements.extend(keys_UI)
scene_5_UI_elements.extend(fight_UI)

scene_5_audio_controller = AudioController(level = 5, bpm = 120, elements = scene_5_game_elements)
scene_5_camera_bounds = ((31.5, 6.5), (155, 13.5))
scene_5_camera = Camera(zoom_factor = 1.1, initial_world_target = scene_5_player.world_pos, speed = 1.05, bounds = scene_5_camera_bounds)
scene_5 = Scene(initial_game_elements = scene_5_game_elements, initial_UI_elements = scene_5_UI_elements, ground_map = scene_5_ground_map, game_camera = scene_5_camera, res = scene_resolution, audio_controller = scene_5_audio_controller, player = scene_5_player, tag = "5")
...
end_game_audio_controller = AudioController(level = 6, bpm = 120)
